  ...
  return (
    <>
      ...
      <div id="map-description" className="sr-only">
        ...
        to navigate controls: Timeline{!isMobile ? ", Save button" : ""}{isDesktop ? ", Zoom controls" : ""}, map area,
        and town markers. Click on the map or press Tab to focus the map area,
        then use arrow keys to pan. When a town marker is focused, use arrow
        keys to navigate between markers.{!isMobile ? " Press Ctrl+S or Cmd+S to save the map as an image." : ""}{isDesktop ? " Press Ctrl+Plus or Cmd+Plus to zoom in, and Ctrl+Minus or Cmd+Minus to zoom out." : " On tablets, use pinch-to-zoom gestures to zoom."} Town markers are color-coded by population size.
      </div>
      <div
