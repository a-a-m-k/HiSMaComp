  ...
  return (
    <>
      ...
      <div id="map-description" className="sr-only">
        ...
        to navigate controls: Timeline, Save button, Zoom controls, map area,
        ...
        keys to navigate between markers. Press Ctrl+S or Cmd+S to save the map
        as an image. Press Ctrl+Plus or Cmd+Plus to zoom in, and Ctrl+Minus or
        Cmd+Minus to zoom out. Town markers are color-coded by population size.
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <ScreenshotButtonContainer timelineHeight={MOBILE_TIMELINE_HEIGHT}>
            <ScreenshotButton />
