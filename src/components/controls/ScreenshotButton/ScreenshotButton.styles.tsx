 ...
 * Handles fixed positioning based on screen size and timeline height.
 */
export const ScreenshotButtonContainer = styled(Box, {
  ...
  [theme.breakpoints.down("sm")]: {
    bottom: timelineHeight + theme.spacing(SPACING.XXL),
    top: "auto",
  },
}));
