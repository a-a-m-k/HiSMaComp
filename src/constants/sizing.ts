...
export const generateLegendStyles = (
  ...
  isMobile: boolean,
  isTablet: boolean
): ComponentStyles => generateComponentStyles(theme, isMobile, isTablet, true);

export const generateTimelineStyles = (
  theme: Theme,
  isMobile: boolean,
  isTablet: boolean
): ComponentStyles => generateComponentStyles(theme, isMobile, isTablet, false);

export const getLegendStyles = (
  theme: Theme,
  isMobile: boolean,
  isTablet: boolean
): ComponentStyles => generateLegendStyles(theme, isMobile, isTablet);

export const getTimelineStyles = (
  theme: Theme,
  isMobile: boolean,
  isTablet: boolean
): ComponentStyles => generateTimelineStyles(theme, isMobile, isTablet);
